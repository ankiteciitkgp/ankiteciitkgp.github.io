...
Since Bonds are also traded their level of safety is less than fixed deposits. But bonds are backed by financial assets while fixed deposits do not have such protection. In case, where the company fails to repay the deposited money the depositor can claim the assets in case of Bonds.
